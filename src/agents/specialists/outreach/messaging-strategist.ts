      ...
      return [
        {
          ...
          businessValue: 'Identify and resolve card decline patterns to capture up to 5% more cross-border transaction revenue without complicating Connect APIs.',
          callToAction: 'Would you be open to reviewing the local-routing benchmarks for European merchants?',
        },
        {
          audience: 'Finance Operations Director',
          messageTheme: 'Outcome-Driven: Automated Tax Compliance Reconciliation',
          businessValue: 'Automates tax collection auditing to eliminate manual billing audit queues, saving up to 15 hours of operations work per week.',
        ...
        },
        {
          ...
          businessValue: 'Directly impacts net payment volume yield by optimizing localized routing rules in secondary European markets.',
          callToAction: 'Are you available for a brief discussion on payment route optimization trends?',
        },
        {
          audience: 'Lead Developer / Architect',
          messageTheme: 'Technical: SDK-first Integration Simplification',
          businessValue: 'Speeds up implementation times by using standardized API connectors, reducing developer integration backlogs.',
      ...
      return [
        {
          ...
          businessValue: 'Synchronizes custom sales pipeline models without hitting HubSpot custom object caps, keeping CRM operations scalable.',
        ...
        },
        {
          ...
          businessValue: 'Increases customer retention rates by synchronizing support activity and success milestones in a unified customer record.',
        ...
        },
        {
          ...
          businessValue: 'Streamlines partner onboarding pipelines to drive higher agency partner channel sales growth.',
          callToAction: 'Should we schedule a short conversation about partner onboarding efficiency?',
        },
        {
          audience: 'CS Operations Architect',
          messageTheme: 'Technical: Granular CRM Object Data Sync',
          businessValue: 'Eliminates API sync latency when pushing customer metrics between external apps and core HubSpot contact timelines.',
      ...
      return [
        {
          ...
          businessValue: 'Automates manual database configuration tasks and reduces complex Apex code dependencies, lowering system total cost of ownership.',
        ...
        },
        {
          ...
          businessValue: 'Accelerates dashboard query speed and removes table performance latency, letting sales leaders analyze pipeline metrics instantly.',
        ...
        },
        {
          ...
          businessValue: 'Improves CRM ROI by removing unnecessary administrative overhead while enabling smart AI discovery capabilities.',
          callToAction: 'Let’s connect to discuss how enterprise firms optimize CRM cost structures.',
        },
        {
          audience: 'Solutions Architect / Developer',
          messageTheme: 'Technical: Real-time Data Cloud Sync Optimization',
          businessValue: 'Improves query execution speeds on large custom object tables through smart indexing and data consolidation.',
      ...
      return [
        {
          ...
          businessValue: 'Unifies scattered databases and identifies duplicate documents automatically, keeping company wikis clean and reliable.',
        ...
        },
        {
          ...
          businessValue: 'Reduces miscommunication cycles between product and engineering by automating link updates and spec-page synchronizations.',
        ...
        },
        {
          ...
          businessValue: 'Ensures strict document permission compliance and protects proprietary knowledge assets at scale.',
        ...
        },
        {
          ...
          businessValue: 'Enables custom workspace security compliance templates, preventing accidental public document exposures.',
      ...
      return [
        {
          ...
          businessValue: 'Replaces multiple external subscriptions with a unified check-out marketing suite, reducing app transaction delays.',
        ...
        },
        {
          ...
          businessValue: 'Allows wholesale buyers to execute transactions with pre-approved credit terms automatically, accelerating wholesale revenue loops.',
        ...
        },
        {
          ...
          businessValue: 'Boosts headless checkout conversion rates and opens up new wholesale channels with lower integration overhead.',
    ...
    return [
      {
        ...
        businessValue: 'Automates manual coordination tasks to boost team productivity and reduce scaling bottlenecks.',
      ...
      },
      {
        ...
        businessValue: 'Improves response rates by helping sales reps craft highly personalized outreach sequences automatically.',
      ...
      },
      {
        ...
        businessValue: 'Accelerates business development growth cycles and reduces customer acquisition cost limits.',
      ...
      },
      {
        ...
        businessValue: 'Secures and accelerates data transfers between core business applications and external platforms.',
