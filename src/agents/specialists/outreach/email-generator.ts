      ...
      followUpSequence = [
        {
          ...
          message:
            'Hi there, I wanted to quickly follow up on my email regarding localized routing benchmarks. I know you are scaling payment operations in Europe and thought this benchmark brief might be useful.',
        ...
        },
        {
          ...
          message:
            'Hi there, following up on our localized checkout routing discussion. Here is a link to a case study detailing how we helped a Tier-1 billing platform minimize merchant payment leakage by 3.2% in under 3 weeks.',
        ...
        },
        {
          ...
          message:
            'Hi, I realize developer resources are likely focused on core product APIs right now. Our integration SDK is pre-configured and connects directly via webhooks, meaning zero disruption to your active code sprint.',
        ...
        },
        {
          ...
          message:
            'Hi there, since I haven’t heard back, I wanted to check if there is a more appropriate stakeholder in payment operations or engineering to coordinate with regarding European localized checkout compliance.',
        ...
        },
        {
          ...
          message:
            'Hi, I assume this isn’t a priority for Stripe payments team right now, so I will stop checking in. If localized payment declines or compliance audits become active issues in the future, feel free to reach back out.',
      ...
      followUpSequence = [
        {
          ...
          objective: 'Context hook / follow-up',
          message:
            'Hi there, I wanted to follow up on my note regarding CRM custom object limits. Since Sales Hub Enterprise is expanding upmarket, optimizing data structures is likely top of mind.',
        ...
        },
        {
          ...
          objective: 'Value drop / case study',
          message:
            'Hi there, I wanted to share this case study showing how we helped a HubSpot partner agency automate custom table setups, saving their developers 20+ hours per client migration.',
        ...
        },
        {
          ...
          objective: 'Objection handling / value prop',
          message:
            'Hi, I know CRM migrations can feel complex. Our integration requires no core system downtime and maps to existing contact timelines through standard webhooks.',
        ...
        },
        {
          ...
          objective: 'Alternative contact query',
          message:
            'Hi there, following up. If custom object constraints or partner portal setups aren’t under your purview, is there another member of the RevOps or CS Ops team I should connect with?',
        ...
        },
        {
          ...
          objective: 'Break-up email',
          message:
            'Hi, it looks like CRM custom object scaling isn’t an active priority for you right now, so I’ll step back. If you face portal sync issues or data limitations in the future, feel free to reach out.',
      ...
      followUpSequence = [
        {
          ...
          objective: 'Context hook / follow-up',
          message:
            'Hi there, I wanted to follow up on my email regarding sales research automation. If your team is scaling outbound campaigns, this could save your reps significant manual research hours.',
        ...
        },
        {
          ...
          objective: 'Value drop / case study',
          message:
            'Hi, following up on our outbound discussion. Here is a brief case study showing how we helped a B2B platform automate account research and double their booked meeting rates in 2 months.',
        ...
        },
        {
          ...
          objective: 'Objection handling / value prop',
          message:
            'Hi, I understand introducing new tools can feel disruptive. Our platform integrates directly with your existing CRM and requires under 15 minutes to set up.',
        ...
        },
        {
          ...
          objective: 'Alternative contact query',
          message:
            'Hi there, since I haven’t heard back, is there another member of your Sales Operations or Enablement team who oversees sales tools and outreach templates?',
          cta: 'Let me know who is best to contact.',
        },
        {
          day: 21,
          objective: 'Break-up email',
          message:
            'Hi, it seems that sales automation isn’t a priority right now, so I will stop checking in. If you face pipeline scaling challenges in the future, feel free to reach back out.',
