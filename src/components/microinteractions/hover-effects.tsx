...
export const hoverEffects = {
  ...
  liftShadow:
    'transition-transform duration-200 hover:-translate-y-1 hover:shadow-md hover:shadow-indigo-500/20',
  ...
  scaleShadow:
    'transition-transform duration-200 hover:scale-105 hover:shadow-md hover:shadow-indigo-500/20',
  ...
  overlayContent:
    'absolute inset-0 bg-indigo-500/0 transition-all duration-300 group-hover:bg-indigo-500/10',

  // Hover underline
  underline:
    'relative after:content-[""] after:absolute after:-bottom-0.5 after:left-0 after:h-0.5 after:w-0 after:bg-indigo-500 after:transition-all duration-200 group-hover:w-full',
  ...
  // Card hover effects
  cardHover:
    'transition-all duration-300 hover:bg-slate-900/70 hover:border-indigo-500/20 hover:shadow-lg hover:shadow-indigo-500/10',

  // Button hover effects
  buttonHover:
    'transition-all duration-200 hover:bg-indigo-600 hover:shadow-md hover:shadow-indigo-500/20',

  // Input hover effects
  inputHover:
    'transition-border-color duration-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/20',
