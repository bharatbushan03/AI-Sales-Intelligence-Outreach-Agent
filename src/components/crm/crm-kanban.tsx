import { Users, DollarSign, TrendingUp, TrendingDown, Clock, MessageCircle, Banknote, Edit, Plus } from 'lucide-react';
      ...
      <div className="space-y-4">
        ...
        <div className="overflow-x-auto">
          <div className="flex space-x-4">
            {crmData.map((column) => (
              <div key={column.id} className="flex-1 min-w-[200px] space-y-3">
                <div className={`p-3 rounded-lg ${column.color}`}>
                  ...
                  <p className="text-xs text-slate-400 mb-2">${(column.value / 1000).toFixed(0)}K in pipeline</p>

                  {/* Leads in Column */}
                  <div className="space-y-2">
                    {column.leads.map((lead) => (
                      <div key={lead.id} className="bg-slate-900/30 border border-slate-800/50 rounded-xl p-3">
                        <div className="flex items-start justify-between">
                          ...
                          <div className="text-right">
                            <p className="text-xs font-medium text-indigo-400">${(lead.value / 1000).toFixed(0)}K</p>
