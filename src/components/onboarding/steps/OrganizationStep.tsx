  ...
  return (
    <div className="rounded-2xl bg-slate-900/50 p-8 shadow-xl backdrop-blur-sm border border-slate-800/50">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Domain */}
        <div>
          <label htmlFor="domain" className="block text-sm font-medium text-slate-200 mb-2">
            Company Domain *
          </label>
          <div className="relative">
            <input
              ...
              className={`block w-full rounded-lg border bg-slate-800/50 px-4 py-3 pl-10 text-white placeholder-slate-400 focus:outline-none focus:ring-2 ${
                errors.domain
                  ? 'border-red-500 focus:ring-red-500'
                  : 'border-slate-600 focus:ring-indigo-500'
              }`}
        ...
        {/* Organization Size */}
        <div>
          <label htmlFor="size" className="block text-sm font-medium text-slate-200 mb-2">
            Organization Size
          </label>
          <div className="relative">
            <select
      ...
      {/* Features Preview */}
      <div className="mt-8 rounded-lg bg-gradient-to-r from-indigo-500/10 to-purple-600/10 p-4 border border-indigo-500/20">
        <h3 className="text-sm font-medium text-indigo-400 mb-2">What you'll get:</h3>
