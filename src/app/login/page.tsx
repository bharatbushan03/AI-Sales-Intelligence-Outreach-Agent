  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 px-4 text-slate-100">
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-800/80 bg-slate-900/30 p-8 backdrop-blur-xl">
        ...
        <form onSubmit={loginMode === 'password' ? handlePasswordLogin : handleMagicLinkLogin} className="space-y-4">
          ...
          {loginMode === 'password' && (
            <div className="space-y-1.5">
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-xs font-semibold text-indigo-400 hover:text-indigo-300">
                  Forgot?
                </Link>
              </div>
              <div className="relative">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white font-bold py-3 text-sm transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
          >
        ...
        <div className="relative my-6 flex items-center justify-center border-t border-slate-800">
          <span className="absolute bg-slate-950 px-3 text-xs font-bold uppercase tracking-widest text-slate-500">
            or continue with
          </span>
        </div>
        ...
        <div className="flex flex-col items-center justify-center gap-2 pt-4 border-t border-slate-850 text-xs text-slate-400">
          <div>
          ...
          <button
            ...
            className="font-semibold text-slate-300 hover:text-slate-100 underline decoration-indigo-500 decoration-2 underline-offset-4"
          >
