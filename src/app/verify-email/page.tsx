  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-slate-950 px-4 text-slate-100">
      <div className="w-full max-w-md space-y-8 rounded-3xl border border-slate-800/80 bg-slate-900/30 p-8 backdrop-blur-xl">
        ...
        {errorMsg && (
          <div className="rounded-xl border border-rose-900/50 bg-rose-950/40 p-4 text-xs font-semibold text-rose-300 text-center flex items-center gap-2 justify-center">
        ...
        <div className="text-sm text-slate-400 text-center leading-relaxed">
          We have sent a verification code link to your email address. Once confirmed, refresh this page or sign in again to access the portal dashboard.
        </div>

        <button
          onClick={handleResend}
          disabled={sending}
          className="w-full rounded-xl bg-indigo-650 hover:bg-indigo-700 text-white font-bold py-3 text-sm transition flex items-center justify-center gap-2 disabled:opacity-50"
        >
