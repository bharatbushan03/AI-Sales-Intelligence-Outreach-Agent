  ...
  return (
    <div className="space-y-8 p-6">
      <div className="flex flex-col space-y-4">
        <h1 className="text-2xl font-bold text-slate-100">Agent Command Center</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4">
          <h2 className="mb-4 text-lg font-semibold text-slate-100">System Metrics</h2>
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-4">
          <h2 className="mb-4 text-lg font-semibold text-slate-100">Active Alerts</h2>
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-0.5">
                <p className="text-sm font-medium text-slate-100">Workflow execution delayed</p>
